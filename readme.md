...
[Java&Android面试基础和进阶知识点](https://github.com/Omooo/Android_QA)    
[各类面试问题汇总](https://github.com/UCodeUStory/DataStructure)    
[👊 持续更新，Java Android 近几年最全面的技术点以及面试题 供自己学习使用](https://github.com/pengMaster/BestNote)    
